...
for (const f of ['src/engine/config.js','src/engine/utils.js','src/engine/items.js','src/engine/recipes.js','src/engine/buildings.js',
'src/engine/research.js','src/engine/maps.js','src/engine/map.js','src/engine/scheduler.js', 'src/engine/railway.js','src/engine/contracts.js', 'src/engine/maintenance.js','src/engine/sim.js','src/engine/researchmgr.js','src/engine/stats.js',
'src/engine/save.js','src/engine/blueprint.js','src/engine/game.js'])

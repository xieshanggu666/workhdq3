...
const files = [
  ...
  'src/engine/research.js', 'src/engine/maps.js', 'src/engine/pipelines.js',
  'src/engine/map.js', 'src/engine/scheduler.js', 'src/engine/railway.js', 'src/engine/contracts.js', 'src/engine/maintenance.js', 'src/engine/sim.js', 'src/engine/researchmgr.js',
  'src/engine/stats.js', 'src/engine/save.js', 'src/engine/blueprint.js', 'src/engine/game.js',
];

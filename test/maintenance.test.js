...
const files = [
  ...
  'src/engine/map.js', 'src/engine/scheduler.js', 'src/engine/railway.js',
  'src/engine/contracts.js', 'src/engine/maintenance.js',
  'src/engine/sim.js', 'src/engine/researchmgr.js', 'src/engine/stats.js',
